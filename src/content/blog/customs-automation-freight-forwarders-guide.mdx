...
For forwarders running customs through CargoWise, the [CargoWise integration](/integrations/cargowise/) pushes validated data via eHub or Universal Gateway. This is the same integration pattern used in the [Hellmann 4PL control tower deployment](/case-studies/hellmann-4pl-control-tower/) — the XML schema mapping adapts to your specific CargoWise configuration, custom fields, and branch codes.
