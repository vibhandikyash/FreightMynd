...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    metaTitle: 'RFQ Email Intelligence — 85% Faster Quotes',
    metaDescription: 'AI-powered RFQ email intelligence for freight forwarders. Auto-classify, complete, and structure incoming RFQs for 85% faster quote turnaround.',
    color: 'brand',
    icon: '📧',
    featured: true,
  },
  {
    ...
    whatWeBuilt: [
      ...
      'Path feasibility intelligence — uses historical decisions to assess route and operational feasibility',
      'Continuous learning — model improves as new operational emails are processed and outcomes are tracked',
    ],
    metaTitle: 'Historical Email Intelligence for Logistics',
    metaDescription: 'AI system that captures institutional knowledge from years of operational email — building a queryable knowledge base from 50K+ email threads.',
    color: 'accent',
    icon: '🧠',
    featured: false,
  },
  {
    ...
    metaTitle: 'Shipping News Intelligence & Risk Detection',
    metaDescription: 'AI-powered freight risk detection — monitors shipping news, port disruptions, and weather events to alert ops teams within 15 minutes of incidents.',
    color: 'brand',
    icon: '🛰️',
    featured: false,
  },
  {
    ...
    metaTitle: 'RFQ & Email Automation — 70% Time Reduction',
    metaDescription: 'End-to-end RFQ lifecycle automation for freight forwarders. Automated vendor selection, distribution, quotation capture, and negotiation workflows.',
    color: 'accent',
    icon: '🔄',
    featured: true,
  },
